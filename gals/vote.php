...
<ul>
   <li><a href='gals.facesofbit.pixub.com' style="color:#000; font-weight:500"><span>Gals</span></a></li>
   <li><a href='boyz.facesofbit.pixub.com'><span>Boyz</span></a></li>
...
<div style="height:80%">
  ...
  <a href="http://facesofbit.pixub.com/rate.php?winner=<?=$images[0]->image_id?>&amp;loser=<?=$images[1]->image_id?>"><img style="width:100%; height:100%" 
  src="http://facesofbit.pixub.com/female/<?=$images[0]->filename?>" /></a></p>
  <p  style="float:right;margin-right:12%;" class="image">
  <a href="http://facesofbit.pixub.com/rate.php?winner=<?=$images[1]->image_id?>&amp;loser=<?=$images[0]->image_id?>"><img style="width:100%; height:100%" 
  src="http://facesofbit.pixub.com/female/<?=$images[1]->filename?>" /></a></p>
</div>
</div>
