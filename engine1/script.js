...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"kenburns",prev:"",next:"",duration:20*100,delay:40*100,width:550,height:550,autoPlay:true,stopOnHover:false,loop:false,bullets:true,caption:false,captionEffect:"fade",controls:true,onBeforeStep:0,images:0});